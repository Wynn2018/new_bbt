  ...
  returnimgID: function () {
    ...
    temp.forEach((item, i) => {
      wx.cloud.uploadFile({
        ...
        filePath: temp[i],
        success: res => {
          console.log('[上传文件] 成功：', temp[i], res)
          id.push(res.fileID)
          that.setData({
            cloudID: id //把图片云端路径赋值给本地的imgid
          })
        },
        fail: e => {
  ...
  changeColor1: function (e) {
    ...
    var check = function (val) { return val == '书籍'; }
  ...
  changeColor2: function (e) {
    ...
    var tag_temp = that.data.tag;
    var length = tag_temp.length;
    var check = function (val) { return val == '化妆品'; }
  ...
  changeColor3: function (e) {
    ...
    var tag_temp = that.data.tag;
    var length = tag_temp.length;
    var check = function (val) { return val == '生活用品'; }
  ...
  changeColor4: function (e) {
    ...
    var tag_temp = that.data.tag;
    var length = tag_temp.length;
    var check = function (val) { return val == '体育用品'; }
  ...
  changeColor5: function (e) {
    ...
    var tag_temp = that.data.tag;
    var length = tag_temp.length;
    var check = function (val) { return val == '其他'; }
